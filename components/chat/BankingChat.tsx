  ...
  useEffect(() => {
    const handleBeforeUnload = () => {
      if (messages.length > 0 && !hasSaved) {
        saveConversationAction(conversationId, 'banking-demo', 'anchorproof-banking');
      }
    };
    ...
    <div className="flex items-center justify-between gap-4 flex-wrap">
      <div className="flex-1">
        <div className="flex items-center gap-2 mb-1">
          ...
          <span className="text-xs font-semibold text-indigo-400 uppercase tracking-wider">Legal Protection</span>
        </div>
        <p className="text-sm text-slate-300">
          Save this conversation as an immutable record. <span className="text-indigo-400">Court-admissible proof</span> for compliance and dispute resolution.
        </p>
      </div>
      <Button
        variant="primary"
        ...
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
          <div className="bg-slate-900 border border-slate-700 rounded-xl p-6 max-w-md w-full mx-4 animate-slide-up">
            <div className="text-center mb-4">
              ...
              <h3 className="text-xl font-bold text-white mb-2">Conversation Saved</h3>
            ...
            <div className="bg-slate-800 p-3 rounded-lg mb-4">
              ...
              <code className="text-cyan-400 text-xs break-all">{savedBlobId}</code>
            </div>
