            ...
            return (
              ...
              >
                <div className="flex justify-center mb-3">
                  <div
                    className={`w-12 h-12 rounded-full bg-${gradientColor}-500/10 flex items-center justify-center group-hover:scale-110 transition-transform`}
                  >
                    {Icon && (
                ...
                <div
                  className={`text-3xl sm:text-4xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-${gradientColor}-400 to-${gradientColor === 'amber' ? 'cyan' : gradientColor === 'emerald' ? 'teal' : gradientColor === 'indigo' ? 'purple' : 'indigo'}-400 mb-2 group-hover:scale-105 transition-transform duration-300`}
                >
                  {stat.value}
                </div>
