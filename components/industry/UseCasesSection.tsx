            ...
            return (
              ...
              >
                <div className="flex items-center gap-3 mb-3">
                  <div
                    className={`w-10 h-10 rounded-xl bg-${gradientColor}-500/10 flex items-center justify-center group-hover:scale-110 transition-transform`}
                  >
                    {Icon && (
                      <Icon className={`w-5 h-5 text-${gradientColor}-400`} />
                    )}
                  </div>
